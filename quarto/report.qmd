...
::: {layout-ncol=2}
![Dataset structure](../figures/trained_teacher_trained_structure.png){width=95%}

![Missing values summary](../figures/trained_teacher_missing.png){width=95%}
:::
...
::: {layout-ncol=2}
![Trained teacher distribution](../figures/trained_teacher_histogram.png){width=95%}

![Trained teacher over time](../figures/trained_teacher_trend.png){width=95%}
:::
...
::: {layout-ncol=2}
![Primary school enrollment trends by gender (2000–2023)](../figures/primary_gender_trends.png){width=95%}

![Gender gap in primary enrollment over time](../figures/primary_gap_trend.png){width=95%}
:::
...
::: {layout-ncol=2}
![Secondary school enrollment trends by gender (2000–2023)](../figures/secondary_gender_trends.png){width=95%}

![Gender gap in secondary enrollment over time](../figures/secondary_gap_trend.png){width=95%}
:::
...
::: {layout-ncol=2}
![Tertiary school enrollment trends by gender (2000–2023)](../figures/tertiary_gender_trends.png){width=95%}

![Gender gap in tertiary enrollment over time](../figures/tertiary_gap_trend.png){width=95%}
:::
...
![Gender gap across all education levels](../figures/gender_gap_by_level.png){width=65%}

::: {layout-ncol=2}
![Male enrollment](../figures/male_enrollment_by_level.png){width=95%}

![Female enrollment](../figures/female_enrollment_by_level.png){width=95%}
:::
...
::: {layout-ncol=2}
![Female tertiary enrollment by region (2023)](../figures/female_tertiary_latest_region.png){width=95%}

![Tertiary gender gap by region (2023)](../figures/tertiary_gap_latest_region.png){width=95%}
:::
...
![Trained teachers vs average secondary enrollment](../figures/teachers_vs_enrollment.png){width=65%}
...
![Trends over time: trained teachers and secondary enrollment](../figures/time_trends.png){width=65%}
...
![Teacher training vs secondary enrollment by gender](../figures/gender_comparison.png){width=65%}
