...
At the primary level, male gross enrollment has consistently exceeded female enrollment across the study period, though the gap has narrowed significantly. In 2000, the gender gap was approximately 7 percentage points, with male enrollment near 100% and female enrollment around 93%. The gap declined steadily through 2016, reaching a low of about 0.6 percentage points, before stabilizing at roughly 1.5 points by 2023. Both rates peaked around 2007–2008 before slightly declining, likely reflecting data reporting patterns across regions.
...
Secondary enrollment shows strong growth for both genders over the entire period. Male enrollment rose from approximately 63% in 2000 to around 83% by 2023, while female enrollment grew from roughly 59% to nearly 90%, with a sharp increase in the most recent years. The gender gap started at about 3.8 percentage points in 2000 and has steadily declined, dipping below zero by 2023 — meaning female secondary enrollment has now slightly surpassed male enrollment globally.
...
When comparing all three levels together, a clear divergence emerges. Primary and secondary gaps started positive (male higher) and have converged toward zero over time. The tertiary gap, already negative in 2000, has accelerated downward to about -15 percentage points by 2023, driven by rapidly rising female tertiary enrollment globally. This suggests that while gender disparities in access to basic education are narrowing, a new and growing gap has emerged at the tertiary level in favor of women.
...
The regional bar charts reveal substantial variation across regions. For female tertiary enrollment in 2023, Australia leads at over 125%, followed by North America (~97%), High income (~91%), and the European Union (~89%). South Asia (~33%), Arab World (~35%), and Lower middle income groups (~27%) have the lowest female tertiary enrollment.

For the tertiary gender gap in 2023, nearly all regions show negative values meaning females outenroll males. Australia has the largest female advantage at about -40 percentage points, followed by North America (~-30) and Latin America & Caribbean (~-19). South Asia and Lower middle income are the only groups near zero, indicating these regions have not yet seen the same reversal in tertiary gender gaps.
...
This project analyzed gender disparities in school enrollment and the distribution of trained teachers across global regions and income groups from 2000 to 2023. Using data from the World Bank's WDI database, we found that gender gaps in primary and secondary enrollment have narrowed substantially over the study period, while at the tertiary level, female enrollment has consistently exceeded male enrollment and the gap has widened to nearly -16 percentage points by 2023. Regional variation is considerable, with high-income regions showing the largest female tertiary advantage and lower-income regions showing the smallest gaps.
