...
![Cleaned long-format structure of the trained teacher dataset](../figures/trained_teacher_trained_structure.png){width=65%}

![Summary of missing values in the trained teacher dataset](../figures/trained_teacher_missing.png){width=65%}
...
![Histogram of trained teacher percentages with mean and median lines](../figures/trained_teacher_histogram.png){width=65%}

![Time-series of trained teacher percentages by year](../figures/trained_teacher_trend.png){width=65%}
...
![Primary school enrollment trends by gender (2000–2023)](../figures/primary_gender_trends.png){width=65%}

![Gender gap in primary enrollment over time](../figures/primary_gap_trend.png){width=65%}
...
![Secondary school enrollment trends by gender (2000–2023)](../figures/secondary_gender_trends.png){width=65%}

![Gender gap in secondary enrollment over time](../figures/secondary_gap_trend.png){width=65%}
...
![Tertiary school enrollment trends by gender (2000–2023)](../figures/tertiary_gender_trends.png){width=65%}

![Gender gap in tertiary enrollment over time](../figures/tertiary_gap_trend.png){width=65%}
...
![Female enrollment rates across all education levels](../figures/female_enrollment_by_level.png){width=65%}

![Male enrollment rates across all education levels](../figures/male_enrollment_by_level.png){width=65%}
...
![Female tertiary enrollment by region (2023)](../figures/female_tertiary_latest_region.png){width=65%}

![Tertiary gender gap by region (2023)](../figures/tertiary_gap_latest_region.png){width=65%}
